    ...
    : QDialog{parent}
{
    ...
    QLabel *copyrightLabel = new QLabel(
        ...
        tr("This program is free software: you can redistribute it and/or modify it under "
           "the terms of the GNU General Public License as published by the Free Software "
           "Foundation, either version 3 of the License, or (at your option) any later version.\n") +
        tr("This program is distributed in the hope that it will be useful, but WITHOUT ANY "
    ...
    setStyleSheet(
        "QDialog { background-color: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #ffffff, stop:1 #3d59ab); }"
