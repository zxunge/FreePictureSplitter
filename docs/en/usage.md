# FreePictureSplitter User Guide

Welcome to FreePictureSplitter – a lightweight yet powerful image splitting tool that supports both precise manual cutting for single images and automated batch processing for hundreds of pictures. This guide will walk you through all the core features.
...
Now you’re ready to make the most of FreePictureSplitter! Whether you’re fine‑tuning a single image or batch‑processing thousands, it’s designed to save you time and effort. If you have any questions, check future help updates or open an issue. Happy splitting!